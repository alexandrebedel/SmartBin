...
with_node \
  ...
  --target "/Users/alexandrebedel/Desktop/Msc/esp/mobile/ios/Pods/Target Support Files/Pods-smartbinesp/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-camera" "expo-constants" "expo-file-system" "expo-keep-awake"
